...
void main() {
  ...
  final tDeletedUserEntity = UserEntity(
    userId: "dsjhbcusdybcy8bhk",
    googleId: tGoogleId,
    userName: "Dhruvam",
    phoneNumber: null,
  ...
  test("DeleteUserUseCase extends usecase", () async {
    // assemble
    // act
    // assert
